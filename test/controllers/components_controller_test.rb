...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { name: @component.name, price: @component.price, stock: @component.stock } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { name: @component.name, price: @component.price, stock: @component.stock } }

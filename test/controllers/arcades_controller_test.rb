...
class ArcadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arcade" do
    assert_difference('Arcade.count') do
      post arcades_url, params: { arcade: { name: @arcade.name, order_id: @arcade.order_id, price: @arcade.price } }
    end
  ...
  test "should update arcade" do
    patch arcade_url(@arcade), params: { arcade: { name: @arcade.name, order_id: @arcade.order_id, price: @arcade.price } }
